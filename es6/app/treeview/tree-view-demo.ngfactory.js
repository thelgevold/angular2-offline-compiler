...
export const TreeViewDemoNgFactory = new import8.ComponentFactory('treeview', viewFactory_TreeViewDemo_Host0, import3.TreeViewDemo);
...
class _View_TreeViewDemo0 extends import1.AppView {
    ...
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        if (((token === import9.TreeView) && (2 === requestNodeIndex))) {
...
export function viewFactory_TreeViewDemo0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TreeViewDemo === null)) {
        (renderType_TreeViewDemo = viewUtils.createRenderComponentType('/Users/tor/Development/angular2-offline-compiler/src/app/treeview/tree-view-demo.ts class TreeViewDemo - inline template', 0, import11.ViewEncapsulation.None, styles_TreeViewDemo, {}));
    }
