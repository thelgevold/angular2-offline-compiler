...
class _View_TreeView1 extends import1.AppView {
    ...
    detectChangesInternal(throwOnChange) {
        ...
        this.detectContentChildrenChanges(throwOnChange);
        const currVal_1 = import5.interpolate(1, '', this.context.$implicit.getIcon(), '');
        ...
        const currVal_4 = import5.interpolate(1, ' ', this.context.$implicit.name, '\n        ');
...
class _View_TreeView3 extends import1.AppView {
    ...
    detectChangesInternal(throwOnChange) {
        this.detectContentChildrenChanges(throwOnChange);
        const currVal_0 = import5.interpolate(1, '', this.context.$implicit, '');
        if (import5.checkBinding(throwOnChange, this._expr_0, currVal_0)) {
