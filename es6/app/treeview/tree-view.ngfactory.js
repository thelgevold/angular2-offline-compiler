...
export const TreeViewNgFactory = new import8.ComponentFactory('tree-view', viewFactory_TreeView_Host0, import3.TreeView);
...
class _View_TreeView0 extends import1.AppView {
    ...
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import9.NgFor) && (2 === requestNodeIndex))) {
...
export function viewFactory_TreeView0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TreeView === null)) {
        (renderType_TreeView = viewUtils.createRenderComponentType('/Users/tor/Development/angular2-offline-compiler/src/app/treeview/tree-view.html', 0, import12.ViewEncapsulation.None, styles_TreeView, {}));
    }
...
class _View_TreeView2 extends import1.AppView {
    ...
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import9.NgFor) && (4 === requestNodeIndex))) {
